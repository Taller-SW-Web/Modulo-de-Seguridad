...
| Día        | Qué pasa                                                                                                                        | Quién                     |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| **Dom 13** | Reunión de arranque (1 h). Se cierra el reparto —incluidos los dos cambios de backlog de `responsabilidades.md` §3—, cada quien acepta su SPEC y crea su rama. Se define el proveedor de nube. | Los 7                     |
